...
export const {useGetCategoryQuery, useGetProductsQuery, useGetProductByIdQuery, usePostOrderMutation, useGetProfileImageQuery, usePostImageProfileMutation} = shopApi;